...
{
	DLList pagerankList; 
	FILE *pagerank = fopen("pagerank.txt", "r");
	pagerankList = newDLList();
	pagerankList = PageRankAppend(pagerank, pagerankList);
	printList(pagerankList);
